...
class ParameterMutator:
    """v25.0 OMEGA: Semantic-Aware Parameter Mutator."""
    ...
    def mutate(self, param_name: str, original_value: Any, mutation_types: List[MutationType]) -> List[Tuple[MutationType, Any]]:
        """v25.0: Selects mutations based on semantic hints and requested types."""
        mutations = []
...
class StatefulLogicFuzzer:
    ...
    async def _execute_fuzz(
        ...
        for param in fuzz_params:
            ...
            mutations = self.mutator.mutate(param, original_value, step.fuzz_types)
